...
export const EXPOTEC = () => {
  ...
  const renderContent = () => {
    switch (selectedSection) {
      case PATHS_EXPOTEC[0]:
        return <DetallesContent />;
      case PATHS_EXPOTEC[1]:
        return <MapaContent />;
      case PATHS_EXPOTEC[2]:
        return <ExpositoresContent />;
      case PATHS_EXPOTEC[3]:
        return <HorarioContent />;
      case PATHS_EXPOTEC[4]:
        return <EntradasContent />;
      default:
        return <DetallesContent />;
    }
  };
      ...
      <main className={EXPOTECStyle.MainContainer}>
        <nav className={EXPOTECStyle.Nav}>
          <div className={EXPOTECStyle.ButtonContainer}>
            <button
              className={EXPOTECStyle.Button}
              onClick={() => toggleSection("detalles")}
            >
              {" "}
              {/*Path to detalles*/}
              <span className={EXPOTECStyle.Text}>
                <strong>Detalles / </strong> EXPOTEC
              </span>
              <i className={EXPOTECStyle.Icon}>
                <TiArrowSortedDown size={"2.2rem"} />
              </i>
            </button>
            <button
              className={EXPOTECStyle.Button}
              onClick={() => setSelectedSection("mapa")}
            >
              <span className={EXPOTECStyle.Text}>
                <strong>Mapa / </strong> EXPOTEC
              </span>
              <i className={EXPOTECStyle.Icon}>
                <TiArrowSortedDown size={"2.2rem"} />
              </i>
            ...
            <button
              className={EXPOTECStyle.Button}
              onClick={() => setSelectedSection("expositores")}
            >
              <span className={EXPOTECStyle.Text}>
                <strong>Expositores / </strong> EXPOTEC
              </span>
              <i className={EXPOTECStyle.Icon}>
                <TiArrowSortedDown size={"2.2rem"} />
              </i>
            ...
            <button
              className={EXPOTECStyle.Button}
              onClick={() => setSelectedSection("horarios")}
            >
              <span className={EXPOTECStyle.Text}>
                <strong>Horarios / </strong> EXPOTEC
              </span>
              <i className={EXPOTECStyle.Icon}>
                <TiArrowSortedDown size={"2.2rem"} />
              </i>
            ...
            <button
              className={EXPOTECStyle.Button}
              onClick={() => setSelectedSection("entradas")}
            >
              <span className={EXPOTECStyle.Text}>
                <strong>Entradas / </strong> EXPOTEC
              </span>
              <i className={EXPOTECStyle.Icon}>
                <TiArrowSortedDown size={"2.2rem"} />
              </i>
      ...
      <main className={EXPOTECStyle.Content}>
        <p className={EXPOTECStyle.paragraph}>
          <span>
            ...
            Exercitationem accusantium similique quo consequatur sed fugit
            officia quos. Quam animi laborum magnam voluptates vero obcaecati
            maiores eveniet! Laboriosam atque tempore facilis.
          </span>
          <span>
        ...
        <div className={EXPOTECStyle.Images}>
          <div className={EXPOTECStyle.ImageDiv}>
            <Image
              ...
              height={400}
              alt="123"
              src="https://www.bisonequipmentandexcavators.com/wp-content/uploads/2024/01/landscape-placeholder-svgrepo-com.svg"
            />
          </div>
          <div className={EXPOTECStyle.ImageDiv}>
            <Image
      ...
      <div className={EXPOTECStyle.ContainerExhibitors}>
        <div className={EXPOTECStyle.gallery}>
          <div className={EXPOTECStyle.galleryItem}>
            <Image width={100} height={100} src="" alt="Imagen minimalista 1" />
          </div>
          <div className={EXPOTECStyle.galleryItem}>
            <Image width={100} height={100} src="" alt="Imagen minimalista 2" />
          </div>
          <div className={EXPOTECStyle.galleryItem}>
            <Image width={100} height={100} src="" alt="Imagen minimalista 3" />
          </div>
        </div>
      </div>
    </>
